 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |-/LCTL| LALT | LGUI | / SandS /       \Enter \  | RGUI |-/RALT|=/RCTL|
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  LCTL_T(KC_MINS),KC_LALT,KC_LGUI,SFT_T(KC_SPC),KC_ENT,  KC_RGUI,RALT_T(KC_MINS),RCTL_T(KC_EQL) \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, KC_K,    _______, _______,                   _______, KC_P7,   KC_P8,   KC_P9,   KC_ASTR, KC_F12,  \
  _______, _______, KC_H,    KC_J,    KC_L,    _______,                   KC_CIRC, KC_P4,   KC_P5,   KC_P6,   KC_RBRC, _______, \
  _______, _______, _______, _______, _______, _______, _______, KC_NLCK, KC_RBRC, KC_P1,   KC_P2,   KC_P3,   XXXXXXX, KC_RSFT, \
                             _______, _______, _______, KC_DEL,  _______, KC_P0,   KC_PDOT, KC_PENT \
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
